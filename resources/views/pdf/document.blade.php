    ...
    <table class="w-full">
        <tr>
            <td class="left">
                ...
                <div>RS Bhayangkara Samsoeri</div>
...
<table class="custom-table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td colspan="2">Rp. 62,404,858</td>
        </tr>
        <tr>
            <td colspan="5" class="text-right">PPN 11%</td>
            <td colspan="2">Rp. 6,864,534</td>
        </tr>
        <tr>
            <td colspan="5" class="text-right">Total + PPN</td>
            <td colspan="2">Rp. 69,269,392</td>
        </tr>
    </tbody>
</table>
